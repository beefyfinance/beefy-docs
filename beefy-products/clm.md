...
With that said, users should be aware that CLM still bears IL risk in these extraordinary scenarios. The value proposition for long-term users is that extreme scenarios may happen for a day or two each year, but the rest of the time their CLM position is safely generating the consistently higher returns that concentrated liquidity offers at minimal effort.
