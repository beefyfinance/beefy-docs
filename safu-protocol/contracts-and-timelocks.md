# Contratos e Timelocks

## **Contratos**

Todos os contratos de cofre implementados no Beefy Finance podem ser visualizados no [dashboard.beefy.finance](https://dashboard.beefy.finance/).

Pode-se usar este painel, por exemplo, para verificar a taxa de [colheita e composição de um cofre](https://docs.beefy.com/moo/faq/how-to-guides/how-to-check-harvesting-compounding-rate).

## Timelocks

Os contratos são protegidos com timelocks e carteiras de desenvolvimento multi-sig.
...
## Multisigs desenvolvedores

As carteiras de desenvolvedor com várias assinaturas são usadas para implementar alterações em contratos, como atualizar estratégias de cofre. Isso garante um fluxo de trabalho seguro onde cada mudança é aprovada pelos desenvolvedores da Beefy.
...
## Multisigs do Tesouro

Os gastos de tesouraria da Beefy são garantidos pela exigência de várias assinaturas de membros confiáveis ​​(da comunidade). [Conforme votado pelo DAO](https://vote-archive.beefy.finance/#/beefy/proposal/QmR5mzwjs46b3YRYWtc12CqqxF6r7VfpPd6ZfiRXnR69go), os seguintes membros representam o Conselho do Tesouro: Power, AllTrades, Pablo, mjoaris, TheBeefyCow, DefiDebauchery e YR2150.
...
Todos os endereços usados ​​são de código aberto e verificáveis. Uma coleção de endereços úteis nas cadeias do Beefy para desenvolvimento de DeFi é armazenada no GitHub: [Address Book](https://github.com/beefyfinance/beefy-api/tree/master/packages/address-book).
