# Contratos & Trancas de Tempo (Timelocks)

## Livro de endereços

Todos os endereços usados ​​são de código aberto e verificáveis. Uma coleção de endereços úteis das redes da Beefy para desenvolvimento da DeFi é armazenada no GitHub: [Livro de Endereços](https://github.com/beefyfinance/beefy-api/tree/master/packages/address-book).

## **Contratos**

Todos os contratos de cofres implementados na Beefy Finance podem ser visualizados no [dashboard.beefy.finance](https://dashboard.beefy.finance/). Pode-se usar este painel, por exemplo, para verificar o ritmo de [coleta e reinvestimento de um cofre](https://docs.beefy.com/moo/faq/how-to-guides/how-to-check-harvesting-compounding-rate).

## Oráculos (Oracles)

Contratos da Beefy **não** usam oráculos externos. O problema com oráculos é, de forma breve, que seus dados podem ser imprecisos e manipulados, oráculosnão confiáveis podem levar a falhas de segurança. Porque os contratos da Beefy **não** se baseiam em dados externos de nenhuma forma, como preços dos ativos, nossos cofres **não** estão suscetíveis a ataques _flashloan_.

## Contratos de Exemplo

* Código do cofre DAI/USDC/USDT (Curve - Avalanche):\
  [https://snowtrace.io/address/0x79A44dc13e5863Cf4AB36ab13e038A5F16861Abc#code](https://snowtrace.io/address/0x79A44dc13e5863Cf4AB36ab13e038A5F16861Abc#code)
* Código da estratégia de empréstimo WBTC (Scream - Fantom):\
  [https://ftmscan.com/address/0x4374207377C1A36e386A757B774D53a0B6Ff2cEE#code](https://ftmscan.com/address/0x4374207377C1A36e386A757B774D53a0B6Ff2cEE#code)
* Código da estratégia regular CAKE-BNB (PancakeSwap - BNB Chain):\
  [https://bscscan.com/address/0xDE238C509bcCBCd91B90dE40dF3e25B43A131311#code](https://bscscan.com/address/0xDE238C509bcCBCd91B90dE40dF3e25B43A131311#code)

## Trancas de Tempo (Timelocks)

Os contratos são protegidos com trancas de tempo e carteiras de desenvolvedor multi-assinatura. Uma tranca de 6 horas é usada pela agilidade de fazer mudanças necessárias para manter nossos contratos seguros e, como uma camada adicional de proteção, a tranca de tempo é governada por uma multi-assinatura de 3/5 assinantes.
...
## Multi-assinaturas de desenvolvedores

As carteiras de desenvolvedor multi- assinaturas são usadas para implementar alterações em contratos, como atualizar estratégias dos cofres. Isso garante um fluxo de trabalho seguro onde cada mudança é aprovada pelos desenvolvedores da Beefy.
...
## Multi-assinaturas da Tesouraria

Os gastos de tesouraria da Beefy são garantidos pela exigência de múltiplas assinaturas de membros confiáveis ​​(da comunidade). [Conforme votados pela DAO](https://vote-archive.beefy.finance/#/beefy/proposal/QmR5mzwjs46b3YRYWtc12CqqxF6r7VfpPd6ZfiRXnR69go), os seguintes membros representam o Conselho da Tesouraria: Power, AllTrades, Pablo, mjoaris, TBC, DefiDebauchery e YR2150. Veja a página [tesouraria.md](../community/tesouraria.md "mention") para mais informações sobre a tesouraria da Beefy.
