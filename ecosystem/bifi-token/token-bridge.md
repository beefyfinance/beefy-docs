...
* [**Chainlink's cross-chain interoperability protocol**](https://chain.link/cross-chain) - Chainlin's cross-chain messaging service which takes advantage of the existing Chainlink's decentralized oracle network.
