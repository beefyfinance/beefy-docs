...
The BIFI token is deployed on all chains where vaults are live. To switch to another chain, use [this guide](../../faq/how-to-guides/how-to-add-and-switch-networks-on-beefy-finance.md) and to bridge BIFI between chains use [this guide](broken-reference). Contract addresses below:
...
* zkSync: [0x44aa3eedd3214ddd02e8b3fe1e8ae4cac452a2e0](https://explorer.zksync.io/address/0x44aa3eedd3214ddd02e8b3fe1e8ae4cac452a2e0)
