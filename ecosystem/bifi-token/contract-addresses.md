...
En todas estas blockchains, puedes hacer staking de $BIFI en los pools nativos para ganar el respectivo token de cada blockchain, o ganar más $BIFI en un vault BIFI Maxi!

## Tenedores de Tokens

La mayoría de los tokens BIFI se encuentran en staking en contratos inteligentes, [BscScan](https://bscscan.com/) tiene una lista detallada de las principales direcciones de staking: [Tenedores de Tokens](https://bscscan.com/token/tokenholderchart/0xca3f508b8e4dd382ee878a314789373d80a5190a).
