...
Holders of inSPIRIT are also entitled to [vote](./#can-i-vote-with-binspirit) in SpiritSwap governance and for the distribution of boosted farm rewards, so the GaugeStaker manages the allocation of these votes.&#x20;
