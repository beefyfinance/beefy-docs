...
Holders of inSPIRIT are also entitled to [vote](../../products/beefy-escrowed-tokens/binspirit.md#puis-je-voter-avec-binspirit) in SpiritSwap governance and for the distribution of boosted farm rewards, so the GaugeStaker manages the allocation of these votes.&#x20;
